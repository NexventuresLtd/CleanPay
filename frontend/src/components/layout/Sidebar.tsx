...
export const Sidebar = () => {
  ...
  const currentNavigation =
    user?.role_details?.name === "system_admin"
  ...
  return (
    <aside className="fixed inset-y-0 left-0 z-50 w-64 bg-bg-base border-r border-border-base flex flex-col">
      {/* Logo */}
      <div className="h-16 flex items-center gap-3 px-6 border-b border-border-base">
      ...
      <nav className="flex-1 overflow-y-auto py-4 px-3">
        ...
        {/* Only show bottom navigation for non-system admins */}
        {user?.role_details?.name !== "system_admin" && (
      ...
      <div className="p-4 border-t border-border-base">
        <div className="flex items-center gap-3 p-2 rounded-lg hover:bg-bg-subtle transition-colors">
